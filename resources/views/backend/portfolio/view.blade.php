                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <a href="{{ route('project_portfolio.create') }}" class="btn btn-info btn-sm"
                                    style="float: right"> + Add Project Portfolio</a>
                            </div>
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    @foreach ($all_project_portfolio as $key => $row)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td><img src="{{ asset($row->portfolio_image) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('project_portfolio.edit', $row->id) }}"
                                                    class="btn btn-info sm" title="Edit Data"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="{{ route('project_portfolio.delete', $row->id) }}" id="delete"
