                            ...
                            <div class="logo">
                                <a href="{{ url('/') }}">
                                    <h1 class="text-primary">
                                        <img src="{{ asset($website_settings->favicon ?? $website_settings->favicon) }}"
                                            alt="XD">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    <li class=" {{ $route == 'home' ? 'active' : '' }}"><a
                                            href="{{ url('/') }}">Home</a></li>
                                    <li class=" {{ $route == 'about' ? 'active' : '' }}"><a
                                            href="{{ route('about') }}">About</a></li>
                                    <li> <a href="#">Services</a></li>
                                    <li class=" {{ $route == 'portfolio' ? 'active' : '' }}"><a
                                            href="{{ route('portfolio') }}">Portfolio</a></li>
                                    <li class=" {{ $route == 'blog' ? 'active' : '' }}"><a
                                            href="{{ route('blog') }}">Our Blog</a></li>
