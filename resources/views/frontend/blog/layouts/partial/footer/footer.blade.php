...
<footer class="footer">
    ...
    <div class="container">
        <div class="row justify-content-between">
            <a href="{{ url('/') }}">
                <h2 class="text-white mb-5">{{ $website_settings->website_name ?? '' }}</h2>
            </a>
            <div class="col-lg-4">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="footer__widget">
                    ...
                    <div class="footer__widget__address">
                        ...
                        <a href="#" class="mail">E-mail :
                            {{ $website_settings->main_email ?? 'noreply@envato.com' }}</a><br>
                        <a href="#" class="mail">E-mail :
                            {{ $website_settings->support_email ?? 'noreply@envato.com' }}</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright__text text-center">
                        <p>Copyright @ <a class="text-white" target="_blank"
                                href="{{ $socials->linkedin ?? '#' }}">{{ $website_settings->website_name }}</a>. 2023
                            All
                            right Reserved</p>
                    </div>
                </div>
