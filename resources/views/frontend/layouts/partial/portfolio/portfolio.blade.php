                            ...
                            @foreach ($all_website as $row)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset($row->portfolio_image ?? 'frontend/assets/img/portfolio/portfolio_img01.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>{{ $row->portfolio_name ?? 'Null' }}</span>
                                        <h4 class="title"><a
                                                href="{{ route('project_portfolio_details', $row->id) }}">{{ $row->portfolio_title ?? 'Null' }}</a>
                                        </h4>
                                        <a href="{{ $row->website_link ?? '#' }}" target="_blank" class="link">Website
                                            View</a>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="col">
                        <div class="portfolio__active">
                            ...
                            @foreach ($all_website_portfolio as $row)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset($row->portfolio_image ?? 'frontend/assets/img/portfolio/portfolio_img07.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                    ...
                    <div class="col">
                        <div class="portfolio__active">
                            ...
                            @foreach ($all_deshboard_portfolio as $row)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset($row->portfolio_image ?? 'frontend/assets/img/portfolio/portfolio_img05.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>{{ $row->portfolio_name ?? 'Web Development' }}</span>
