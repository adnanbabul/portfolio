        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <hr>
                    <div class="p-3">
                        <form method="POST" action="{{ route('website_settings_data.insert') }}"
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="description" class="form-control" rows="5"
                                        placeholder="Please Type Website Description"></textarea>
                            ...
                            <div class="form-group row mt-3 pt-1">
                                <div class="col-12">
                                    <button class="btn btn-primary waves-effect waves-light" type="submit">Insert Website
